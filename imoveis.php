...
<script type="text/javascript">
	function aparecerImagem(){
		...
		for(i = 1; i < table.rows.length; i++){
			table.rows[i].cells[5].innerHTML = "<img width = '100px' height = '100px' src = '"+table.rows[i].cells[4].innerHTML+"' />";
		}
...
<span style = "background-color:#E8E8E8;border:solid 1px gray;font-weight:bolder;color:black;padding:5px;cursor:pointer;padding-left:10px;padding-right:10px;" onclick="window.open(document.referrer,'_self');">&lt; Voltar</span>
 
<a href = "novoImovel.php" style = "text-decoration:none;" ><span style = "background-color:blue;font-weight:bolder;color:white;padding:5px;cursor:pointer;border:solid 1px DarkBlue;padding-left:10px;padding-right:10px;margin:1px;"> + Novo </span></a>
...
<td style = "border:solid 1px gray;padding:5px;font-weight:bolder;background-color:white;" >
CEP<img onclick = "mudarImagem(3)" id = "img3" src = "imagens/setadesativada.jpg" height = "20px" width = "7px" style = "float:right;cursor:pointer;" />
</td>
<td style = "border:solid 1px gray;padding:5px;font-weight:bolder;background-color:white;" >
...
<tr>    
  ...
  <td style = "width:150px;padding:5px;border:solid 1px black;" >
...
echo "<tr style = 'cursor:pointer;' id = ".$row["id"]." onMouseOver = 'MudarOpacity(".$row["id"].")' onMouseOut = 'MudarOpacityRetorno(".$row["id"].")' onclick = 'EditarExcluir(&apos;".$row["id"]."&apos;, &apos;".$row["valor"]."&apos;, &apos;".$row["cep"]."&apos;, &apos;".$row["informacoes"]."&apos;, &apos;".$row["imagem"]."&apos;)' ><td style = 'border:solid 1px gray;padding:5px;width:50px;' >
	 ".$row["id"]."
	  </td>";
...
<!--Código para filtrar dados em javascript baixado da internet
...
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1">
  ...
  <tr>    
  <td width="301">
  <input name="filt" type="text" onKeyUp="filter(this, 'lista', '0')">
  </td>
  <td width="100">
  <input name="filt2" type="text" onKeyUp="filter(this, 'lista', '1')">
  </td>    
  <td width="135">
  <input name="filt3" type="text" onKeyUp="filter(this, 'lista', '2')">
  </td>    
  <td width="146">
  <input name="filt4" type="text" onKeyUp="filter(this, 'lista', '3')">
  </td>    
  <td width="48">
  <input name="filt5" type="text" onKeyUp="filter(this, 'lista', '4')">
  </td>  
  </tr>
  </table>
  <form>       
