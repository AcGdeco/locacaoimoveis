...
echo "<tr><td style = 'border:none;padding:10px;' ><a href = 'editarexcluirimovel.php' style = 'text-decoration:none;' ><span style = 'background-color:#E8E8E8;border:solid 1px gray;font-weight:bolder;color:black;padding:5px;cursor:pointer;padding-left:10px;padding-right:10px;'>&lt; Voltar</span></a></td></tr>";
...
$sql = "UPDATE imoveis SET valor='$valor', cep='$cep', informacoes='$informacoes', imagem='$target_file' WHERE id='$id'";
